...
int main(int argc, char **argv)
{
    ...
    // START OF TEST
    printf("\n[INFO] Parse header and decrypt:\n");                // FIXME: only for current test
    printf("------ ------------------------------------------\n"); // FIXME: only for current test
    printf("[DEBUG] Bytes in: ");                                  // FIXME: only for current test
    print_byte_array(bytes_in, msg_len);                           // FIXME: only for current test
    printf("%d,\n", msg_len);                                      // FIXME: only for current test
    for (int test = 0; test < 50; test++)                          // FIXME: only for current test
    {
    ...
    printf("[DEBUG] Bytes out: ");        // FIXME: only for current test
    print_byte_array(bytes_out, msg_len); // FIXME: only for current test
    // END OF TEST
